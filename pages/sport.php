...
<head>
    ...
    <title id="unit">Спорт | Logotip news</title>
...
<body class="page-category page-sport">
        ...
        <nav class="main-nav">
            <div class="container nav-flex">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="/pages/sport.php" id="sports" class="active">Спорт</a></li>
        ...
        <div class="container category-container">
            ...
            <div class="category-main">
                ...
                <div class="category-heading">
                    <h1>Спорт</h1>
                    <p>Главные спортивные события, результаты матчей, трансферы и аналитика.</p>
                </div>
                ...
                <?php else: ?>
                    ...
                    <div class="no-news">
                        Пока нет спортивных новостей на выбранном языке.
                    </div>
            ...
            <aside class="category-sidebar">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-authors">
                        ...
                        <div class="sidebar-author">
                            ...
                            <div>
                                <strong>Максат Иманов</strong>
                                <span>27 статей</span>
                            </div>
                        </div>

                        <div class="sidebar-author">
                            <img src="https://i.pravatar.cc/60?img=23" alt="">
                            <div>
                                <strong>Илья Соколов</strong>
                                <span>19 статей</span>
                            </div>
                        </div>
                ...
                <div class="telegram-box">
                    ...
                    <h3>
                        Не пропустите спортивные события
                    </h3>

                    <p>
                        Получайте свежие новости спорта каждый день
                    </p>
